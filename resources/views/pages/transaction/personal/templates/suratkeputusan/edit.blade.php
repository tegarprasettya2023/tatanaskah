...
<div class="card mb-4">
    <form action="{{ route('transaction.personal.suratkeputusan.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="card-body row">
            {{-- Copy semua field dari create.blade.php tapi dengan value dari $data --}}
            ...
            <div class="col-md-8 mb-3">
                ...
                <input type="text" class="form-control" id="judul_setelah_sk" name="judul_setelah_sk" 
                       value="{{ old('judul_setelah_sk', $data->judul_setelah_sk) }}">
            </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control @error('nomor_sk') is-invalid @enderror" 
                       ...
                       value="{{ old('nomor_sk', $data->nomor_sk) }}" required>
                @error('nomor_sk')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="date" class="form-control @error('tanggal_sk') is-invalid @enderror" 
                       ...
                       value="{{ old('tanggal_sk', $data->tanggal_sk?->format('Y-m-d')) }}" required>
                @error('tanggal_sk')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-12 mb-3">
                ...
                <textarea class="form-control @error('tentang') is-invalid @enderror" 
                          id="tentang" name="tentang" rows="2" required>{{ old('tentang', $data->tentang) }}</textarea>
                @error('tentang')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            {{-- MENIMBANG dengan data existing --}}
            <div class="col-12 mb-4 mt-3">
                        ...
                        <div class="menimbang-item card mb-2">
                            <div class="card-body py-2">
                                <div class="d-flex justify-content-between mb-1">
                                    <label class="form-label">{{ chr(97 + $i) }}. bahwa ...</label>
                                    @if($i > 0)
                    ...
                    @else
                        <div class="menimbang-item card mb-2">
                            <div class="card-body py-2">
                                ...
                                <textarea name="menimbang[]" class="form-control" rows="2"></textarea>
                            </div>
                        </div>
                    @endif
                </div>
            ...
            {{-- MENGINGAT dengan data existing --}}
            <div class="col-12 mb-4 mt-3">
                <div class="d-flex justify-content-between align-items-center border-bottom pb-2">
                ...
                <div id="mengingat-wrapper">
                    @if(!empty(old('mengingat', $data->mengingat)))
                        ...
                        <div class="mengingat-item card mb-2">
                            <div class="card-body py-2">
                                <div class="d-flex justify-content-between mb-1">
                                    <label class="form-label">{{ chr(97 + $i) }}. Undang-undang ...</label>
                                    @if($i > 0)
                    ...
                    @else
                        <div class="mengingat-item card mb-2">
                            <div class="card-body py-2">
                                ...
                                <textarea name="mengingat[]" class="form-control" rows="2"></textarea>
                            </div>
                        </div>
                    @endif
                </div>
            ...
            <div class="col-12 mb-3">
                ...
                <textarea class="form-control" id="menetapkan" name="menetapkan" rows="2">{{ old('menetapkan', $data->menetapkan) }}</textarea>
            </div>

            {{-- KEPUTUSAN dengan data existing --}}
            <div class="col-12 mb-4 mt-3">
                <div class="d-flex justify-content-between align-items-center border-bottom pb-2">
            ...
            <div class="col-12">
                <div id="keputusan-wrapper">
                    @php $angkaTerbilang = ['', 'Kesatu', 'Kedua', 'Ketiga', 'Keempat', 'Kelima', 'Keenam', 'Ketujuh']; @endphp
                    @if(!empty(old('keputusan', $data->keputusan)))
                        @foreach(old('keputusan', $data->keputusan) as $i => $item)
                        <div class="keputusan-item card mb-2">
                            <div class="card-body py-2">
                                <div class="d-flex justify-content-between mb-1">
                                    <label class="form-label">{{ $angkaTerbilang[$i + 1] ?? ($i + 1) }}</label>
                                    @if($i > 0)
                                ...
                                <textarea name="keputusan[]" class="form-control" rows="2">{{ $item }}</textarea>
                            </div>
                        </div>
                        @endforeach
                    @else
                        <div class="keputusan-item card mb-2">
                            <div class="card-body py-2">
                                ...
                                <textarea name="keputusan[]" class="form-control" rows="2"></textarea>
                            </div>
                        </div>
                    @endif
                </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="ditetapkan_di" name="ditetapkan_di" 
                       value="{{ old('ditetapkan_di', $data->ditetapkan_di) }}">
            </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="date" class="form-control @error('tanggal_ditetapkan') is-invalid @enderror" 
                       ...
                       value="{{ old('tanggal_ditetapkan', $data->tanggal_ditetapkan?->format('Y-m-d')) }}" required>
            ...
            <div class="col-md-12 mb-3">
                ...
                <input type="text" class="form-control" id="nik_kepegawaian" name="nik_kepegawaian" 
                       value="{{ old('nik_kepegawaian', $data->nik_kepegawaian) }}">
            </div>

            {{-- TEMBUSAN dengan data existing --}}
            <div class="col-12 mb-4 mt-3">
                <div class="d-flex justify-content-between align-items-center border-bottom pb-2">
            ...
            <div class="col-12">
                <div id="tembusan-wrapper">
                    ...
                    @else
                        <div class="tembusan-item card mb-2">
                            <div class="card-body py-2">
                                <input type="text" name="tembusan[]" class="form-control" placeholder="Penerima tembusan 1">
                            </div>
                        </div>
                    @endif
                </div>
            ...
            <div class="col-12 mb-3">
                ...
                <input type="text" class="form-control" id="keputusan_dari" name="keputusan_dari" 
                       value="{{ old('keputusan_dari', $data->keputusan_dari) }}">
            </div>
            ...
            <div class="col-12 mb-3">
                ...
                <input type="text" class="form-control" id="lampiran_tentang" name="lampiran_tentang" 
                       value="{{ old('lampiran_tentang', $data->lampiran_tentang) }}">
            </div>
        </div>
        ...
        <div class="card-footer">
            ...
            <a href="{{ route('transaction.personal.suratkeputusan.show', $data->id) }}" class="btn btn-secondary">
...
.menimbang-item, .mengingat-item, .keputusan-item, .tembusan-item { background-color: #f8f9fa; }
</style>
@endpush
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    addMenimbangBtn.addEventListener("click", function () {
        const huruf = String.fromCharCode(97 + menimbangIndex);
    ...
    let keputusanIndex = {{ !empty(old('keputusan', $data->keputusan)) ? count(old('keputusan', $data->keputusan)) : 1 }};
