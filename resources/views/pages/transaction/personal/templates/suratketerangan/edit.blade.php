...
@section('content')
<x-breadcrumb :values="[__('menu.transaction.menu'), 'Surat Pribadi', 'Edit Surat Keterangan']" />
...
<div class="card mb-4">
    <form action="{{ route('transaction.personal.surat_keterangan.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
        <input type="hidden" name="template_type" value="surat_keterangan">

        <div class="card-header">
            <h5>Edit Surat Keterangan</h5>
        </div>
        ...
        <div class="card-body row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="date" class="form-control @error('letter_date') is-invalid @enderror" 
                       ...
                       value="{{ old('letter_date', $data->letter_date ? $data->letter_date->format('Y-m-d') : '') }}" required>
                @error('letter_date')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('nama_yang_menerangkan') is-invalid @enderror" 
                       ...
                       value="{{ old('nama_yang_menerangkan', $data->nama_yang_menerangkan) }}" required>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('nik_yang_menerangkan') is-invalid @enderror" 
                       ...
                       value="{{ old('nik_yang_menerangkan', $data->nik_yang_menerangkan) }}" required>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('jabatan_yang_menerangkan') is-invalid @enderror" 
                       ...
                       value="{{ old('jabatan_yang_menerangkan', $data->jabatan_yang_menerangkan) }}" required>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('nama_yang_diterangkan') is-invalid @enderror" 
                       ...
                       value="{{ old('nama_yang_diterangkan', $data->nama_yang_diterangkan) }}" required>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('nip_yang_diterangkan') is-invalid @enderror" 
                       ...
                       value="{{ old('nip_yang_diterangkan', $data->nip_yang_diterangkan) }}" required>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('jabatan_yang_diterangkan') is-invalid @enderror" 
                       ...
                       value="{{ old('jabatan_yang_diterangkan', $data->jabatan_yang_diterangkan) }}" required>
            ...
            <div class="col-12 mb-3">
                ...
                <textarea class="form-control @error('isi_keterangan') is-invalid @enderror" 
                          id="isi_keterangan" name="isi_keterangan" rows="8" required>{{ old('isi_keterangan', $data->isi_keterangan) }}</textarea>
        ...
        <div class="card-footer">
            ...
            <a href="{{ route('transaction.personal.surat_keterangan.show', $data->id) }}" class="btn btn-secondary">
